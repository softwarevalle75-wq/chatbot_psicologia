...
export async function iniciarRecoleccionDatos(telefono, nuevoRol) {
  try {
    ...
    const mensaje =
      '✅ *Tu perfil de practicante ha sido activado automáticamente.*\n\n' +
      'No necesitas hacer nada más ahora. El administrador completará tu EPS/IPS, Clínica y horarios de atención pronto.\n\n' +
      '👉 *Envía cualquier mensaje* para continuar.';
...
export async function enviarBienvenidaPracticante(telefono, datosPracticante) {
  try {
    let mensaje = `🎉 *¡Bienvenido al equipo de practicantes!*\n\n` +
      ...
      `📌 *Próximos pasos:*\n` +
      `El administrador completará tu EPS/IPS, Clínica y horarios de atención.\n\n` +
