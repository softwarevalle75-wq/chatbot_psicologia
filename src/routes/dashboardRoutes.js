...
const getDashboardSummary = async (practitionerEmail = null) => {
  ...
  /* ── 2b. Deduplicate: keep only FIRST test per patient ── */
  // GHQ-12: keep earliest record per telefono (by informePdfFecha, tiebreak by idGhq12)
  ...
  // DASS-21 (HistorialTest): keep earliest record per usuarioId (by fechaCompletado, tiebreak by id)
  ...
  // GHQ-12 HistorialTest: keep earliest record per usuarioId (for subscales)
